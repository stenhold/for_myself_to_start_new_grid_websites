      ...
      <GridContainer>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 pt-16">
          <GridItem className="col-span-1">
            <h1 className="text-3xl text-right text-gray-900 font-light font-kanit">About Biosense</h1>
            <h2 className="text-sm text-right text-gray-800 font-light font-kanit">
              Our mission is to help bring <br /> advanced sensor technologies to market.
            </h2>
          </GridItem>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          <GridItem className="col-span-2 w-full h-full">
            <Image
              src="/images/biosense_office.png"
              alt="French Salon"
              width={800}
              height={600}
              layout="responsive"
